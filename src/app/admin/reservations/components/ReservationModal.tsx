            ...
            <div className="bg-white rounded-xl w-full max-w-lg p-8 max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    />
                                    <span className="absolute right-4 top-2.5 text-gray-500 text-sm font-medium pointer-events-none">ท่าน</span>
                                </div>
                            </div>
                            <div>
                                <label className="block text-sm font-bold text-gray-700 mb-1.5">เลือกโต๊ะ (ไม่บังคับ)</label>
                                <select
                                ...
                                >
                                    ...
                                    {tables.map(t => (
                                        <option key={t.id} value={t.id}>โต๊ะ {t.name} ({t.capacity} ที่นั่ง)</option>
                                    ))}
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1.5">คำขอพิเศษเพิ่มเติม (จากลูกค้า)</label>
                            <textarea
                        ...
                        {initialData?.payment_slip_url && (
                            <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                <label className="block text-sm font-black text-blue-800 uppercase tracking-widest mb-2">หลักฐานการชำระเงิน (สลิป)</label>
                                <div className="mt-2 text-center">
                                    ...
                                    <p className="mt-2 text-xs text-blue-500 font-medium italic">* คลิกที่รูปเพื่อดูขนาดใหญ่</p>
                                </div>
                            </div>
                        )}

                        <div className="p-4 bg-orange-50 rounded-xl border border-orange-100">
                            <label className="block text-sm font-black text-orange-800 uppercase tracking-widest mb-2">หมายเหตุพนักงาน (Staff Only)</label>
                            <textarea
