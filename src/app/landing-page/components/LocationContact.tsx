                    ...
                    <div className="space-y-6">
                        <div className="bg-background rounded-xl p-6 shadow-warm-sm">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-foreground mb-2">{t('contact.phone')}</h3>
                                    <a
                        ...
                        <div className="bg-background rounded-xl p-6 shadow-warm-sm">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-foreground mb-2">{t('contact.address')}</h3>
