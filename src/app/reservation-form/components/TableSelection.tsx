              ...
              `}
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center justify-between mb-1">
                                    <span className={`font-semibold ${isSelected ? 'text-primary' : isBooked ? 'text-red-500/90' : 'text-foreground'}`}>
                                        {table.name}
                                    </span>
                                    {isBooked ? (
                                ...
                                <p className={`text-sm line-clamp-2 ${isBooked ? 'text-red-400/80' : 'text-muted-foreground'}`}>
                                    {table.description}
                                </p>
